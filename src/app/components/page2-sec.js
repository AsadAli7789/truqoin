...
export default function Gsap({ color }) {
  ...
  const divv3 = useRef(null);
  const divv4 = useRef(null);
  // const divv5 = useRef(null);
  ...
  useEffect(() => {
    ...
    tll = gsap.timeline({
      scrollTrigger: {
        ...
        end: "+=200%", // End the animation after scrolling the height of the viewport
        scrub: 1,
        markers: true,
  ...
  return (
    <>
      ...
      <div
        ref={main_div}
        className="  h-fit relative  xl:max-w-[1330px]   mx-auto overflow-hidden w-[98vw]  xl:w-[100vw]  flex justify-between "
      >
        <div ref={divv} className={`  w-[50%] translate-y-[0vh] h-[138px] `}>
          ...
          <h2 className=" text-[14px] font-[600] font-montserrat text-[#8E8E8E] px-2">
            <ul>
              <li className="flex gap-x-2 items-center text-[14px] leading-[17.07px]">
                <div id="dot" className="w-[10px] h-[10px] rounded-full "></div>
        ...
        >
          <div
            id="Gsap"
            className=" h-[555px] xl:p-4  flex-col p-4 flex xl:justify-center xl:items-center lg:w-[450px] xl:w-[650px] border-[#343434] rounded-[10px] "
          >
          ...
          <div
            id="Gsap"
            className=" h-[284px] xl:p-4  flex-col p-4 flex xl:justify-center xl:items-center lg:w-[450px] xl:w-[650px] border-[#343434] rounded-[10px]"
          >
            <div className="lg:w-[343px] xl:w-[543px] h-[179px]  my-3  ">
              <div>
                <svg
